...
string ground_truth_file = "./example/ground_truth.txt";
...
int main(int argc, char **argv) {
  TrajectoryType groundTruth = ReadTrajectory(ground_truth_file);
  TrajectoryType estimated = ReadTrajectory(estimated_file);
  assert(!ground_truth_file.empty() && !estimated_file.empty());
